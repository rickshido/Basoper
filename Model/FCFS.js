...
var FCFS = (function () {
    ...
    FCFS.prototype.idExists = function (idJob) {
    ...
    FCFS.prototype.insertExecTable = function (idJob, instruction) {
        var i;
        var newJob;
        newJob = Array();
    ...
    FCFS.prototype.testInsertExecTable = function () {
    ...
    FCFS.prototype.nextStepExecQueue = function () {
        var jobString;
        var i;
        var j;
        var instruction;
    ...
    FCFS.prototype.updateJobEntries = function () {
        var counter;
    ...
    FCFS.prototype.sortShortestJob = function () {
        var x;
        var y;
        var troca;
        var a;
    ...
    FCFS.prototype.getTotalInstructions = function () {
        var counter;
    ...
    FCFS.prototype.nextStepExecTimeLine = function () { return; };
    FCFS.prototype.getExecQueue = function () { return this.execQueue; };
    FCFS.prototype.getBlockedQueue = function () { return this.blockQueue; };
    FCFS.prototype.getJobsStatistcs = function () { return this.execStatistics; };
    FCFS.prototype.execFull = function () { };
    FCFS.prototype.getExecCounter = function () { return this.execCounter; };
    FCFS.prototype.getTccTime = function () { return this.TCC_TIME; };
    FCFS.prototype.getCpuUtilization = function () { return this.cpuUtilization; };
    FCFS.prototype.getIdleCPU = function () { return this.idleCPU; };
    return FCFS;
})();
